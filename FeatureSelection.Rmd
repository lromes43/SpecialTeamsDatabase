...
PlocIDVar <- var(data_norm$PLocID)
print(PlocIDVar)


SnapLocIDVar <- var(data_norm$SnapLocID)
print(SnapLocIDVar)

PDateVar <- var(data_norm$PDate)
print(PDateVar)

SnaptimeVar <- var(data_norm$Snaptime)
print(SnaptimeVar)

OPVar <- var(data_norm$OP)
print(OPVar)

H2FVar <- var(data_norm$H2F)
print(H2FVar)

HangVar <- var(data_norm$Hang)
print(HangVar)

DistanceVar <- var(data_norm$Distance)
print(DistanceVar)

PrecipitationVar <- var(data_norm$precipitation)
print(PrecipitationVar)

WindVar <- var(data_norm$Wind)
print(WindVar)

TempVar <- var(data_norm$Temp)
print(TempVar)
