...
```{r}
IG_PlayerIDP <- gain_ratio(data$PlayerIDP, data_norm$PLocID)
print(IG_PlayerIDP)
IG_Distance <- gain_ratio(data$Distance, data_norm$PLocID)
print(IG_Distance)
IG_PlayerIDLS <- gain_ratio(data$PlayerIDLS, data_norm$PLocID)
print(IG_PlayerIDLS)
IG_SnapLocID <- gain_ratio(data$SnapLocID, data_norm$PLocID)
print(IG_SnapLocID)
IG_PDate <- gain_ratio(data$PDate, data_norm$PLocID)
print(IG_PDate)
IG_Snaptime <- gain_ratio(data$Snaptime, data_norm$PLocID)
print(IG_Snaptime)
IG_OP <- gain_ratio(data$OP, data_norm$PLocID)
print(IG_OP)
IG_H2F <- gain_ratio(data$H2F, data_norm$PLocID)
print(IG_H2F)
IG_Hang <- gain_ratio(data$Distance, data_norm$PLocID)
print(IG_Hang)
IG_Practice <- gain_ratio(data$Practice,data_norm$PLocID)
print(IG_Practice)
IG_Game <- gain_ratio(data$Game, data_norm$PLocID)
print(IG_Game)
IG_Precipitation <- gain_ratio(data$precipitation,data_norm$PLocID)
print(IG_Precipitation)
IG_Wind <- gain_ratio(data$Wind, data_norm$PLocID)
print(IG_Wind)
IG_Grass <- gain_ratio(data$Grass, data_norm$PLocID)
print(IG_Grass)
IG_Turf <- gain_ratio(data$Turf, data_norm$PLocID)
print(IG_Turf)
IG_Temp <- gain_ratio(data$Temp, data_norm$PLocID)
print(IG_Temp)
```
```{r}
IGValues <- c(
  Distance = IG_Distance,
  Game = IG_Game,
  Grass = IG_Grass,
  H2F = IG_H2F,
  Hang = IG_Hang, 
...
```{r}
MI_PlayerIDP <- mutinformation(data_norm$PlayerIDP, data_norm$PLocID, method = "emp")
MI_Distance <- mutinformation(data_norm$DistanceCat, data_norm$PLocID, method = "emp")
MI_PlayerIDLS <- mutinformation(data_norm$PlayerIDLS, data_norm$PLocID, method = "emp")
MI_SnapLocID <- mutinformation(data_norm$SnapLocID, data_norm$PLocID, method = "emp")
MI_PDate <- mutinformation(data$PDate, data_norm$PLocID, method = "emp")
MI_Snaptime <- mutinformation(data_norm$SnaptimeCat,data_norm$PLocID, method = "emp") ##ommitted due to continuous
MI_OP <- mutinformation(data_norm$OPCat, data_norm$PLocID, method = "emp")       ##ommitted due to continuous
MI_H2F <- mutinformation(data_norm$H2FCat,data_norm$PLocID, method = "emp")     ##ommitted due to continuous
#MI_Distance <- mutinformation(data_norm$DistanceCat,  data_norm$DistanceCat, method = "emp")
MI_Hang <- mutinformation(data_norm$HangCat, data_norm$PLocID, method = "emp")
MI_Practice <- mutinformation(data_norm$Practice,  data_norm$PLocID, method = "emp")
MI_Game <- mutinformation(data_norm$Game,  data_norm$PLocID, method = "emp")
MI_Wind <- mutinformation(data_norm$WindCat, data_norm$PLocID, method = "emp")
MI_Grass <- mutinformation(data_norm$Grass,  data_norm$PLocID, method = "emp")
MI_Turf <- mutinformation(data_norm$Turf,  data_norm$PLocID, method = "emp")
MI_Precipitation <- mutinformation(data_norm$precipitationCat,  data_norm$PLocID, method = "emp")
MI_Temp <- mutinformation(data_norm$TempCat,  data_norm$PLocID, method = "emp")
```
...
game = data.frame (data$GameCat, data$PLocID)
game = table(data$GameCat, data$PLocID)
print(game)
...
grass = data.frame(data$GrassCat, data$PLocID)
grass = table(data$GrassCat, data$PLocID)
print(grass)
...
H2F = data.frame(data$H2FCat, data$PLocID)
H2F = table(data$H2FCat, data$PLocID)
print(H2F)
...
Hang = data.frame(data$HangCat, data$PLocID)
Hang = table(data$HangCat, data$PLocID)
print(Hang)
...
##OP Table
OP = data.frame(data$OPCat,data$PLocID)
OP = table(data$OPCat, data$PLocID)
print(OP)
...
PlayerIDLS = data.frame(data$PlayerIDLSCat,data$PLocID)
PlayerIDLS = table(data$PlayerIDLSCat, data$PLocID)
print(PlayerIDLS)
...
PlayerIDP = data.frame(data$PlayerIDPCat, data$PLocID)
PlayerIDP = table(data$PlayerIDPCat, data$PLocID)
print(PlayerIDP)
...
Distance = data.frame(data$DistanceCat,data$PLocID)
Distance = table(data$DistanceCat, data$PLocID)
print(Distance)
...
Practice = data.frame(data$PracticeCat, data$PLocID)
Practice = table(data$PracticeCat, data$PLocID)
print(Practice)
...
SnapLocID = data.frame(data$SnapLocIDCat, data$PLocID)
SnapLocID = table(data$SnapLocIDCat, data$PLocID)
print(SnapLocID)
...
Turf = data.frame(data$TurfCat,data$PLocID)
Turf = table(data$TurfCat, data$PLocID)
print(Turf)
...
Wind = data.frame(data$WindCat, data$PLocID)
Wind = table(data$WindCat, data$PLocID)
print(Wind)
...
Temp = data.frame(data$TempCat, data$PLocID)
Temp = table(data$TempCat, data$PLocID)
print(Temp)
...
Snaptime = data.frame(data$SnaptimeCat, data$PLocID)
Snaptime = table(data$SnaptimeCat, data$PLocID)
print(Snaptime)
...
Precipitation = data.frame(data$precipitationCat, data$PLocID)
Precipitation = table(data$precipitationCat, data$PLocID)
print(Precipitation)
...
DaysSinceAug1 <- data.frame(data$DaysSinceAug1Cat, data$PLocID)
DaysSinceAug1 <- table(data$DaysSinceAug1Cat, data$PLocID)
print(DaysSinceAug1)
...
##Applying Chi2
```{r}
DistanceChi <- print(chisq.test(Distance)) ## test for dist
...
```{r}
PCC_Distance <- cor.test(data_norm$Distance, data_norm$PLocID, method = "pearson")
PCC_Hang <- cor.test(data_norm$Hang, data_norm$PLocID, method = "pearson")
PCC_Game<- cor.test(data_norm$Game, data_norm$PLocID, method = "pearson")
PCC_Grass <- cor.test(data_norm$Grass, data_norm$PLocID, method ="pearson")
PCC_H2F <- cor.test(data_norm$H2F, data_norm$PLocID, method = "pearson")
PCC_OP <- cor.test(data_norm$OP, data_norm$PLocID, method = "pearson")
PCC_PDate <- cor.test(data_norm$PDate, data_norm$PLocID, method = "pearson")
PCC_PlayerIDLS <- cor.test(data_norm$PlayerIDLS, data_norm$PLocID, method = "pearson")
PCC_PlayerIDP <- cor.test(data_norm$PlayerIDP, data_norm$PLocID, method = "pearson")
PCC_PLocID <- cor.test(data_norm$PLocID, data_norm$PLocID, method = "pearson")
PCC_Practice <- cor.test(data_norm$Practice, data_norm$PLocID, method = "pearson")
PCC_Precipitation<- cor.test(data_norm$precipitation, data_norm$PLocID, method = "pearson")
PCC_SnapLocID <- cor.test(data_norm$SnapLocID, data_norm$PLocID, method = "pearson")
PCC_Snaptime <- cor.test(data_norm$Snaptime, data_norm$PLocID, method = "pearson")
PCC_Temp <- cor.test(data_norm$Temp, data_norm$PLocID, method = "pearson")
PCC_Turf <- cor.test(data_norm$Turf, data_norm$PLocID, method = "pearson")
PCC_Wind <- cor.test(data_norm$Wind, data_norm$PLocID, method = "pearson")
```

```{r}
PCC <- c(
  Distance = PCC_Distance,
  Game = PCC_Game,
  Grass = PCC_Grass,
  H2F = PCC_H2F,
  Hang = PCC_Hang, 
...
VTTurf <- variances[selected_features[20]] 
VTDistance <- variances[selected_features[10]]
VTWind <- variances[selected_features[17]]
