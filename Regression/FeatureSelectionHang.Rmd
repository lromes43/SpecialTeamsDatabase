...
IG_Distance <- 0.15 # Replace with actual calculation result e.g. mutinformation(your_main_data_discretized$Distance, your_main_data_discretized$TargetVariable)
IG_Game <- 0.20
IG_Grass <- 0.05
IG_H2F <- 0.10
IG_OP <- 0.18
